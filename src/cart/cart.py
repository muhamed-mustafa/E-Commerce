...
class Cart(object):
    ...
    def __iter__(self):
        ...
        for item in cart.values():
            item['PRDPrice']    = Decimal(item['PRDPrice'])
            item['total_price'] = item['PRDPrice'] * item['quantity']
            yield item
    ...
    def get_total_price(self):
        ...
        return sum(Decimal(item['PRDPrice']) * item['quantity'] for item in self.cart.values())
